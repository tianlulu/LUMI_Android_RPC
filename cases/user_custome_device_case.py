...
class All_Cases():
    ...
    def run_test(self):
        ...
        for device_info in range(len(device_list)):
            ...
            if device_list[device_info][2] == "lumi.plug.mmeu01":
            ...
            if device_list[device_info][2] == "lumi.ctrl_ln1.aq1":
                print('lumi.ctrl_ln1.aq1')
                my_custom_name.set_ctrl_ln1_aq1_room_name(device_list[device_info][0])
                my_custom_name.set_ctrl_ln1_aq1_device_name(device_list[device_info][1])
