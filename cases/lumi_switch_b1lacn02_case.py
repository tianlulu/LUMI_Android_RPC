...
from handle.lumi_switch_b1lacn02_handle import Switch_B1lacn02_Handle
...
class Switch_B1lacn02_Case(unittest.TestCase):
    ...
    def test_case1(self):
        '''找出Aqara墙壁开关(零火线单键版)'''
        global room_exists
        room_exists = self.switch_b1lacn02_handle.click_room_element()
        self.assertTrue(room_exists,'滑动到底部仍然没有找到房间')

        global device_exists
        device_exists = self.switch_b1lacn02_handle.click_device_element()
